/*
 * Initialization and configuration code for the 'IoT PWM' app.
 ...
 *     altPin:   30            // initialize alternate pin for I/O
 * } ;
 ...
 * @member {Number} PWM class constructor parm, mraa PWM pin #
 * @member {Boolean} PWM class constructor parm, PWM object lifetime owner
 * @member {Number} PWM class constructor parm, PWM object "Chip ID"
 */
    ...
    cfg.ioChipId = -1 ;         // set to constructor default
    ...
    cfg.init = function() {
        ...
        switch( cfg.mraa.getPlatformType() ) {          // which board are we running on?
            ...
            case cfg.mraa.INTEL_GT_TUCHUCK:             // Joule (aka Grosse Tete)
                io = opt.altPin ? io : 32 ;             // use alternate pin?
                break ;
